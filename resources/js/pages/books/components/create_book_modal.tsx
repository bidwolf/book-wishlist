    ...
    <Dialog open={openModal} onOpenChange={open => setOpenModal(open)}>
      ...
      <DialogContent>
        ...
        <form onSubmit={onSubmit} className="grid grid-cols-3">
          ...
          <div className="col-span-full">
            <Label htmlFor="genre">Gênero do livro</Label>
            <Input
              value={data.genre}
              onChange={onChange}
              onBlur={onBlur}
          ...
          <div className="col-span-full">
            ...
            <Input
              ...
              onChange={onChange}
              onBlur={onBlur}
              placeholder="Informe a data de lançamento do livro"
              name="release_date"
              id="release_date" type="date" className="appearance-none" />
          </div>
          ...
          <div className="col-span-full">
            ...
            <Input
              ...
              onChange={onChange}
              onBlur={onBlur}
              placeholder="Insira o código ISBN do livro"
              name="ISBN"
              id="ISBN" />
          </div>
